...
```bash
sudo BRANCH=v1.1.1 INSTALL_DIR=/opt/3wg-panel bash /tmp/3wg-update.sh
```
...
```bash
sudo BRANCH=v1.1.1 INSTALL_DIR=/opt/3wg-panel bash scripts/update.sh
```
