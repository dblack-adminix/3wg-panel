...
Для упрощённой редакции используйте отдельную инструкцию: [Установка 3WG Easy Core](../easy-core/README.md). Там также описана безопасная замена уже установленной 3WG Core с сохранением пиров и конфигураций.
