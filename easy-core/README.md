...
git clone --branch v1.8.0 --depth 1 https://github.com/dblack-adminix/3wg-panel.git /tmp/3wg-panel
cd /tmp/3wg-panel
...
```bash
git clone --branch v1.8.0 --depth 1 https://github.com/dblack-adminix/3wg-panel.git /tmp/3wg-panel-easy
